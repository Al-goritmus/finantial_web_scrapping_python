...
canvas_base64_2 = driver.execute_script("return arguments[0].toDataURL('image/jpeg').substring(23);", canvas2)
canvas_base64_3 = driver.execute_script("return arguments[0].toDataURL('image/jpeg').substring(23);", canvas3)
